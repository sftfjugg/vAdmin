...
import (
	...
	log2 "vAdmin/apis/log"
	"vAdmin/apis/monitor"
	"vAdmin/apis/system"
	"vAdmin/apis/system/dict"
	. "vAdmin/apis/tools"
	_ "vAdmin/docs"
	"vAdmin/handler"
	"vAdmin/middleware"
...
func sysCheckRoleRouterInit(r *gin.RouterGroup, authMiddleware *jwtauth.GinJWTMiddleware) {
	...
	r.Group("").Use(authMiddleware.MiddlewareFunc()).GET("/wsdeploy/:id/:channel/:demandid", ws.WebsocketManager.WsDeployClient)
