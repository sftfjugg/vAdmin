...
func (e *SysUser) Encrypt() (err error) {
	...
	log.Println("请求到 Encrypt：",e.Password)
	var hash []byte
...
func (e *SysUser) Update(id int) (update SysUser, err error) {
	...
	//e.Password = ""
	log.Println("xxxxxxxxxxxxxxxxxxxxxxxxe.Password:",e.Password)
...
func (e *SysUser) SetPwd(pwd SysUserPwd) (Result bool, err error) {
	...
	log.Println("xxxxxxxxxxxxxxxxxxxxxxxxx---更新密码成功")
	return
}
